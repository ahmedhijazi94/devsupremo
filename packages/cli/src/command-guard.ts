...
export const KNOWN_COMMANDS = ['bootstrap', 'prepare', 'runtime-preview', 'authorize', 'checkpoint', 'daemon', 'sync', 'db', 'turn', 'host', 'engine', 'jobs', 'secrets', 'auth', 'integrations', 'functions'] as const
