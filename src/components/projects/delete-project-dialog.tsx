  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="hover:bg-down text-down-ink ml-2 rounded-[var(--radius-control)] p-1.5 transition-colors"
  ...
  return (
    <div className="bg-ink/25 fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
      <div className="bg-surface relative w-full max-w-md rounded-[var(--radius-inner)] p-6 shadow-lg">
        <div className="text-down-ink mb-4 flex items-center gap-3">
          <div className="bg-down rounded-full p-2">
        ...
        <p className="text-muted mb-4 text-sm">
          ...
          <strong className="text-down-ink">IRREVERSÍVEL</strong>:
        </p>
        ...
        <form onSubmit={handleDelete} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="bg-sunken placeholder:text-muted focus:ring-down-ink w-full rounded-[var(--radius-control)] px-3 py-2 text-sm focus:ring-2 focus:outline-none"
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              ...
              className="bg-down-ink text-surface hover:bg-down-ink rounded-md px-4 py-2 text-sm font-medium transition-colors disabled:opacity-50"
            >
