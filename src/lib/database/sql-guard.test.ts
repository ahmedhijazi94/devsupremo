...
describe('assertSafeSql — furos encontrados atacando o guard', () => {
  ...
  describe('escrita escondida em CTE — consulta de leitura é só leitura', () => {
...
describe('assertSafeDataChange — ajuste de dado sem migration', () => {
  ...
  it('recusa DDL — estrutura vai por migration versionada', () => {
    expect(() =>
      assertSafeDataChange('ALTER TABLE profiles ADD COLUMN x int'),
    ).toThrow(/migration versionada/)
  ...
  it('recusa SELECT — leitura é do consulta de leitura', () => {
