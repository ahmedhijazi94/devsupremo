// Frozen from engine release 8f027a328c2797da5f317a2b093f91362f929451 (Next 4.0.10 / Start 5.0.0).
// Do not regenerate from current templates.
import type { ValidationManifest } from '../../../../packages/cli/src/validation-integrity'
export const TRUSTED_VALIDATION_POLICIES_4_0_10_5_0_0: readonly ValidationManifest[] = [
  {
    "version": "4.0.10",
    "kind": "public",
    "files": {
    ...
    "lock": [
      ...
      [
        "tools/supremo-cli",
        "0e5e7185df789a28e2759bbe9521d2fb8620471b5a35cbda64488c106955ed53"
      ]
    ]
  },
  {
  ...
  },
  {
    ...
    "files": {
      ...
      "vite.config.mts": "3c51225206870200f294e9c5301e2f515d059f0a",
