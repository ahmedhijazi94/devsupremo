// Frozen from engine release 3071f69596ab18e8c5a224c734af1227b22ec069 (4.0.8).
// Do not regenerate from the current scaffold.
...
const common = {
  ...
  "lock": [
    ...
    [
      "tools/supremo-cli",
      "00c3610072b5ed3b7afc18c698a2ae7c054d88bb02a4deee3d8c77349bc7b1eb"
    ]
  ]
}
export const TRUSTED_VALIDATION_POLICIES_4_0_8: readonly ValidationManifest[] = [
  {
    "kind": "public",
    "files": {
...
.map(policy => ({ version: common.version, kind: policy.kind, files: policy.files, scripts: common.scripts, devDependencies: common.devDependencies, lock: Object.fromEntries(common.lock) }))
